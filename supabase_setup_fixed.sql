-- ============================================
-- Vibe Your Mind - Fixed Database Schema
-- ============================================
-- 修复版本: 所有外键改为引用 profiles(id) 而非 auth.users(id)
-- ============================================
...
DROP TABLE IF EXISTS idea_collaborators CASCADE;
...
DROP FUNCTION IF EXISTS update_idea_comments_count();
DROP FUNCTION IF EXISTS update_idea_likes();
DROP FUNCTION IF EXISTS update_project_likes();

-- ============================================
-- 3. 用户配置表 (profiles) - 核心表
-- ============================================
...
-- ============================================
-- 6. 评论系统 (comments) - 外键改为 profiles(id)
-- ============================================
...
-- ============================================
-- 9. 聊天消息 (messages) - 外键改为 profiles(id)
-- ============================================
...
-- ============================================
-- 10. 赏金悬赏 (bounties) - 外键改为 profiles(id)
-- ============================================
...
-- ============================================
-- 11. 提示词黑胶 (vinyls) - 外键改为 profiles(id)
-- ============================================
CREATE TABLE vinyls (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  title TEXT NOT NULL,
...
-- ============================================
-- 12. 精品项目 (projects) - 外键改为 profiles(id)
-- ============================================
...
-- ============================================
-- 13. Storage Buckets 配置
-- ============================================
-- 请在 Supabase Dashboard → Storage 中手动确认以下 Buckets:
-- 1. user-uploads (public) - 已存在
-- 2. avatars (public) - 可选
-- 3. project-images (public) - 可选
...
-- 
-- 关键改动:
-- 1. 所有业务表外键从 auth.users(id) 改为 profiles(id)
-- 2. 保持 profiles 与 auth.users 的触发器同步机制
-- 3. 添加必要的索引优化查询性能
-- 4. RLS 策略全部重新配置
-- ============================================
